    ...
    <div className="flex flex-col w-full h-[600px] md:h-[380px] lg:h-[380px] overflow-hidden md:flex-row lg:flex-row">
      {cards.map((card) => (
        <div
          ...
          className={`
            relative flex flex-col justify-end px-6 pb-7 overflow-hidden cursor-default
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              {card.services.map((s) => (
                <li key={s} className="flex items-center gap-2 text-xs text-white/65 whitespace-nowrap">
                  <span
