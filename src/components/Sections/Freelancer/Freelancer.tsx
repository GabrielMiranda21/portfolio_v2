...
export default function Freelancer() {
    return (
        <section id="experiencia" className="flex flex-col items-center gap-6 px-6 md:px-56 py-30 bg-white w-full">
            ...
            <Button variant="cta" className=" flex justify-center items-center px-12 py-4 font-bold text-2xl text-[#1B263B] border border-[#4361EE] rounded-xl max-w-[280px]">Entrar em contato</Button>
        </section>
    )
}