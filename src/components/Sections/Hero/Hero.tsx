...
export default function Hero () {
    return (
        <section id="#Inicio" className={`flex flex-col justify-center items-center text-center gap-6 ${gradientHero} py-60 px-6`}>
            <Photo />
            <div>
            ...
            <div className="flex flex-col justify-center items-center gap-6 w-full md:flex-row lg:flex-row">
                ...
                <Button variant="primary" className="flex justify-center items-end flex-nowrap gap-2 text-[#ffffff] text-lg py-4 px-6 md:w-71 lg:w-71 rounded-xl">
