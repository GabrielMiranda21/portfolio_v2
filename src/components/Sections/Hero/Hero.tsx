...
const gradientHero: string = 'bg-gradient-to-r from-[#1E1F48] to-[#0A0C14]'
...
export default function Hero() {
    return (
        <section id="inicio" className={`relative flex flex-col justify-center items-start text-center gap-6 ${gradientHero} pt-40 pb-30 px-6 lg:px-12 w-full overflow-x-hidden`}>
            ...
            <div className="flex flex-col justify-center items-center w-full md:items-center lg:items-start max-w-[1200px] mx-auto">
                ...
                <h1 className="flex flex-col items-center text-h1 w-full font-extrabold mb-4 text-white lg:items-start lg:max-w-3xl">
                    <span
                ...
                <div className="flex gap-6 justify-center lg:justify-start mt-6">
                    <Link href={'https://github.com/GabrielMiranda21'} target="_blank" className="flex justify-center items-center rounded-full bg-white/10 w-12 h-12 hover:bg-white/20">
                        <Icon path={mdiGithub} size={1} color="#EDF3FF"/>
                    </Link>
                    <Link href={'https://www.linkedin.com/in/gabriel-miranda-363269205/'} target="_blank" className="flex justify-center items-center rounded-full bg-white/10 w-12 h-12 hover:bg-white/20">
                        <Icon path={mdiLinkedin} size={1} color="#EDF3FF"/>
                    </Link>
                    <Link href={'https://www.behance.net/gabrielacoustic1'} target="_blank" className="flex justify-center items-center rounded-full bg-white/10 w-12 h-12 hover:bg-white/20">
                        <SiBehance size={24} color="#EDF3FF"/>
                    </Link>
                </div>
            </div>
        </section>
