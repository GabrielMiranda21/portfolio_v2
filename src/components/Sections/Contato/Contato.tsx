    ...
    return (
        <section id="contato" className="flex flex-col gap-6 px-3 lg:px-48 py-30 bg-white">
            ...
            >
                ...
                <fieldset className="flex flex-col gap-4 border border-[#6B7280] rounded-[14px] p-6">
                    <div className="flex flex-col gap-2 lg:gap-4 w-full md:flex-row">
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <input
                                ...
                                className="p-3 bg-[#0D1117] border border-[#6B7280] rounded-[14px] text-white text-body-default font-normal"
                            />
                        </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <textarea
                            ...
                            className="p-3 bg-[#0D1117] border border-[#6B7280] rounded-[14px] text-white text-body-default font-normal h-25 lg:h-50"
                        />
                    </div>
                    ...
                    <Button
                        ...
                        className={`
                            px-6 py-4 rounded-[14px] w-full disabled:bg-[#4B5563] disabled:text-[#f9fafb] ]
